...
export function DashboardNav({ user, profile }: DashboardNavProps) {
  ...
  const complianceNavigation = [
    {
      name: "Đăng ký FDA",
      href: "/dashboard/fda-registrations",
      icon: (
        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
  ...
  const companyServiceNavigation =
    profile?.role === "admin" || (profile?.role !== "system_admin" && profile?.company_id)
      ? [
          {
            name: "Gói dịch vụ của tôi",
    ...
    <aside className="w-64 border-r bg-white">
      ...
      <nav className="flex-1 space-y-1 p-4">
        ...
        <div className="my-4 border-t pt-4">
          <p className="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Tuân thủ FDA</p>
        ...
        {companyServiceNavigation.length > 0 && (
          <div className="my-4 border-t pt-4">
            <p className="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Dịch vụ</p>
          ...
          <>
            <div className="my-4 border-t pt-4">
              <p className="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">
                {profile?.role === "system_admin" ? "System Admin" : "Quản trị"}
              </p>
        ...
        {serviceNavigation.length > 0 && (
          <div className="my-4 border-t pt-4">
            <p className="px-3 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Quản lý Dịch vụ</p>
      ...
      <div className="border-t p-4">
        ...
        <div className="mb-3 rounded-lg bg-slate-50 p-3">
          ...
          <p className="text-xs text-slate-500 capitalize">
            {profile?.role === "system_admin" ? "System Administrator" : profile?.role || "viewer"}
          </p>
        </div>
