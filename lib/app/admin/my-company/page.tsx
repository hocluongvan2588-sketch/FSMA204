...
export default async function AdminMyCompanyPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Công ty của tôi</h1>
          <p className="text-slate-500 mt-1">Thông tin doanh nghiệp của bạn</p>
        </div>
        {hasCompany && canEdit && (
          <Button asChild>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-slate-500 mb-6 text-center max-w-md">
              Bạn chưa được gán vào công ty nào. Vui lòng liên hệ quản trị viên hệ thống để được hỗ trợ.
            </p>
          </CardContent>
        </Card>
      ) : (
