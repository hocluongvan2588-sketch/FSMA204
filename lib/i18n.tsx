  ...
  en: {
    ...
    facilities: {
      ...
      fields: {
        ...
        agentRegistrationYears: "Number of Years",
      },
      alerts: {
        agentWarning:
          "⚠️ CRITICAL: Without Agent Registration Date, FDA registration becomes INVALID immediately! This can halt all exports.",
        expiryCalculation:
          "FDA registration is valid for 2 years (biennial renewal). Expiry date will be auto-calculated.",
        fdaAutoCalculate:
          "FDA expiry date is automatically calculated to the end of the next even year. Vexim Global will handle the registration for you.",
        agentExpiryAutoCalculated:
          "Agent expiry date is automatically calculated from registration date and selected years.",
        expiryAutoCalculated: "Expiry date is automatically calculated based on registration date.",
        requiredFields: "Please fill in all required fields before proceeding.",
      },
      types: {
  ...
  vi: {
    ...
    facilities: {
      ...
      fields: {
        ...
        agentRegistrationYears: "Số năm",
      },
      alerts: {
        agentWarning:
          "⚠️ QUAN TRỌNG: Không có Ngày Đăng ký Đại diện, đăng ký FDA sẽ MẤT HIỆU LỰC ngay lập tức! Có thể dừng toàn bộ xuất khẩu.",
        expiryCalculation:
          "Đăng ký FDA có hiệu lực 2 năm (gia hạn hai năm một lần). Ngày hết hạn sẽ được tính tự động.",
        fdaAutoCalculate:
          "Ngày hết hạn FDA được tính tự động đến cuối năm chẵn tiếp theo. Vexim Global sẽ xử lý đăng ký cho bạn.",
        agentExpiryAutoCalculated: "Ngày hết hạn Đại diện được tính tự động dựa trên ngày đăng ký và số năm đã chọn.",
        expiryAutoCalculated: "Ngày hết hạn được tính tự động dựa trên ngày đăng ký.",
        requiredFields: "Vui lòng điền đầy đủ tất cả các trường bắt buộc trước khi tiếp tục.",
      },
      types: {
        production: "Sản xuất",
        processing: "Chế biến",
    ...
    admin: {
      ...
      facilities: {
        ...
        alerts: {
          ...
          expiryCalculation:
            "Đăng ký FDA có hiệu lực 2 năm (gia hạn hai năm một lần). Ngày hết hạn sẽ được tính tự động.",
          fdaAutoCalculate: "Ngày hết hạn FDA được tính tự động đến cuối năm chẵn",
          agentExpiryAutoCalculated: "Ngày hết hạn Đại diện được tính tự động dựa trên ngày đăng ký và số năm",
          expiryAutoCalculated: "Ngày hết hạn được tính tự động dựa trên ngày đăng ký.",
